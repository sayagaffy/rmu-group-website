...
export const miningContent: MiningContent = {
  hero: {
    ...
    subtitle:
      "Powering the global EV revolution with responsible resource extraction",
  ...
  introduction: {
    ...
    description:
      "RMU Group operates strategic nickel mining sites across Indonesia, leveraging the country's position as the world's largest nickel reserve holder. Our mining operations are designed with sustainability and efficiency at the core.",
    highlights: [
  ...
  strategic: {
    ...
    description:
      "Our mining operations are strategically located across key nickel-rich regions in Indonesia",
    regions: [
      {
  ...
  sustainability: {
    ...
    description:
      "We are committed to minimizing environmental impact while maximizing social and economic benefits for local communities",
    initiatives: [
      {
        title: "Land Rehabilitation",
        description:
          "Progressive rehabilitation of mined areas with native vegetation, ensuring biodiversity restoration",
        image: "/images/mining/sustainable-mine.jpg",
      },
      {
        title: "Water Management",
        description:
          "Advanced water recycling systems and sediment control to protect local water sources",
        image: "/images/mining/water-management.jpg",
      },
      {
        title: "Community Development",
        description:
          "Investment in local infrastructure, education, and healthcare facilities",
